...
import { Link, useRouteMatch, Route, HashRouter as Router, Switch} from 'react-router-dom'
...
const ControlPanelWrapper = () => {
    ...
    <header className="header" id="header">
            ...
            <div className="d-flex justify-content-between align-items-center">
                <Link style={{margin:'0px'}} to={path+'notifications'}><i className="bx bx-bell me-2" style={{color:'#000', fontSize:'1.7rem'}}></i></Link>
        ...
        <nav className="nav">
            ...
            <div> 
                ...
                <div className="nav_list"> 
                    ...
                    <Link to={path}  className="to-students nav_link nav_l"> <i className='bx bx-user nav_icon'></i> <span className="nav_name">Students</span> </Link> 
                    <Link to={path}  className="to-instrucs nav_link nav_l"> <i className='bx bx-user nav_icon'></i> <span className="nav_name">Instructors</span> </Link> 
                    ...
                    <Link to={path}  className="to-trans nav_link nav_l"> <i className='bx bx-money nav_icon'></i> <span className="nav_name">Transactions</span> </Link> 
                </div>
            </div>
